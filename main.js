...
const endQuiz = () => {
  ...
  congratsText.innerHTML = `Congratulations on completing the ${quizCategory} Quiz! 🎉. <br>
  Your scored ${score}/15 <br>
  You can Retake the Quiz if you'd like or Quit and try another Quiz`;
